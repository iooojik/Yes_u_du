...
class RegisterFragment : Fragment(), EditAccountHelper, LocationUtil, View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        binding.maleSelector.setOnClickListener(this)
        binding.femaleSelector.setOnClickListener(this)
        ...
        binding.callCalendarTextView.setOnClickListener {
            ...
            picker.addOnPositiveButtonClickListener { selection: Any? ->
                dateOfBirth = Calendar.getInstance(TimeZone.getTimeZone(timeZone))
                if (dateOfBirth != null) {
                    ...
                    if (isAge) {
                        ...
                        binding.ageTextField.editText!!.setText(
                            formatDate(
        ...
        if (address != null) {
            binding.countryTextField.editText!!.setText(address.countryName)
            binding.regionTextField.editText!!.setText(address.adminArea)
            binding.cityTextField.editText!!.setText(address.locality)
        }
        return binding.root
    }
    ...
    private fun setRegistration() {
        ...
        val sex =
            if (binding.maleSelector.tag != null && binding.maleSelector.tag == true) resources.getString(
                R.string.male_sex
            )
            else if (binding.femaleSelector.tag != null && binding.femaleSelector.tag == true) resources.getString(
                R.string.female_sex
            )
            else return
                    ...
                    if (task.isSuccessful) {
                        if (auth!!.currentUser != null) {
                            ...
                            ref = db!!.getReference("users")
                                .child(
                                    Objects.requireNonNull(auth!!.currentUser)!!
                                        .uid
                                )
    ...
    override fun onClick(p0: View?) {
        when (p0!!.id) {
            R.id.male_selector -> {
                binding.maleSelector.tag = true
                binding.femaleSelector.tag = false
                binding.maleSelector.setBackgroundResource(R.drawable.sex_square_activated)
                binding.femaleSelector.setBackgroundResource(R.drawable.sex_square)
            }
            R.id.female_selector -> {
                binding.maleSelector.tag = false
                binding.femaleSelector.tag = true
                binding.femaleSelector.setBackgroundResource(R.drawable.sex_square_activated)
                binding.maleSelector.setBackgroundResource(R.drawable.sex_square)
            }
        }
    }
}